...
const SearchBar = () => {
    ...
    const {currentCategory, currentSubcategory, currentAvailability, currentBrand, currentSort, currentPage, limit, query} = useAppSelector(state => state.filterReducer)
    const {cartItems} = useAppSelector(state => state.itemReducer)
