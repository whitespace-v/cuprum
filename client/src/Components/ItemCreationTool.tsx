...
const ItemCreationTool = () => {
    ...
    const {currentAvailability, currentSubcategory, currentCategory, currentBrand, currentSort, currentPage, limit, query} = useAppSelector(state => state.filterReducer)
